...
//		});
		...
		Optional<Integer> min = 
				numbers.stream().min( (n1, n2) -> n1.compareTo(n2) );

		Optional<Integer> max = 
				numbers.stream().max( (n1, n2) -> n1.compareTo(n2) );
		
		
		System.out.println("최소값 : " + min.get()); // get() : optional안에 있는 값을 가져온다
		System.out.println("최대값 : " + max.get());
		
		
		/*reduce(초기값, (a,b) -> {})
		 * - 스트림 요소를 이용해서 하나의 값을 도출
		 * - 도출 되려는 결과는 "초기값" 변수에 누적됨
		 * */
